                        ...
                        <div class="inner">
                            ...
                            <div class="top">
                                <ul class="tab_list" data-aos="fade-up" data-aos-duration="600">
                                    ...
                                    <li class="on focus"><a href="/sub.do?MENUID=02_02_0023&MENUNO=2">폐수</a></li>
                                </ul>
                            </div>
                            <div class="circulation_wrap" data-aos="fade-up" data-aos-offset="400">
                                <p class="s_tit">사업장에서 발생한 산∙알칼리 등의 <b>다양한 성상의 폐수를 증발농축, 물리∙화학처리 등</b>의 과정을 거쳐
                                    공공폐수처리장으로 연계처리하여 환경보전에 기여하고 있습니다.</p>
                                <div class="img">
                                    <!-- <div class="tag">폐수</div> -->
                                    <img src="/resources/service/env/images/business/circulation_img03.jpg" alt="호남환경에너지주식회사 이미지">
                                </div>
                                <div class="desc">
                                    <h4>호남환경에너지주식회사</h4>
                                    <div class="wasteoil">
