<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
                            ...
                            <div class="ethic_wrap ethical_intro_wrap">
                                <section class="section1" data-aos="fade-up" data-aos-duration="700" data-aos-delay="600">
                                    <div class="s_title_img">
                                        <img src="/resources/service/env/images/sustain/ethical_manage_tit.png" alt="Ethical Management">
                                        <img src="/resources/service/env/images/sustain/ethical_manage_tit_m.png" alt="Ethical Management">
                                    </div>
                                    <h3>윤리경영이란?</h3>
           ...
           <script>currentPageNum(3,0);</script>