                        ...
                        <div class="inner">
                            ...
                            <div class="top">
                                <ul class="tab_list" data-aos="fade-up" data-aos-duration="600">
                                    ...
                                    <li class="on focus"><a href="/sub.do?MENUID=02_03_0013&MENUNO=2">재활용 폐기물 선별시설 O&M</a></li>
                                </ul>
                            </div>
                            <div class="newbiz_wrap03 newbiz_wrap" data-aos="fade-up" data-aos-offset="400">
                                <p class="s_tit">
                                    재활용 폐기물 선별시설 O&M사업은 차별화된 운영 <br class="br_m">노하우, 기술력, 최신 자동화설비를 적용하여<br>
                                    배출된 폐기물에서 활용이 가능한 자원으로 <br class="br_m">분리·선별하는 사업입니다.
                                </p>
                                <h4>[ 재활용 선별장 Process ]</h4>
                                <div class="preocess_wrap">
                                    <img src="/resources/service/env/images/business/newbiz03_img.png" alt="New Biz 선별장 O&M 이미지">
                                    <img src="/resources/service/env/images/business/newbiz03_img_m.png" alt="New Biz 선별장 O&M 이미지">
                                </div>
                            </div>
