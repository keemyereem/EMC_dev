...
<!-- // 나무 // -->
    ...
    <c:set var="now" value="<%=new java.util.Date()%>" />
                ...
                <section class="section1 on">
                        ...
                        <div class="level">
                            <div class="carbon_number">
                                <div class="carbon_number_inner">
                                    ...
                                    <p><span class="carbon_date"><fmt:formatDate value="${now}" pattern="yyyy.MM.dd hh:mm" /></span> 기준</p>
                                </div>
                            </div>
                    ...
                    <div class="count3">
                        <div class="tree">
                            <a href="/env/carbonReduc/carbonReducDtl.do?MENUID=3&SUB_MENUNO=3"><img src="/resources/service/env/images/main/sec1_tree1_on.png" data-animated="/resources/service/env/images/main/sec1_tree1.gif" data-static="/resources/service/env/images/main/sec1_tree1_on.png" alt="tree"></a>
                            ...
                            <ul class="tree_counts">
                                <li>
                                    ...
                                    <p class="count" data-aos="fade-up" data-aos-delay="500" data-aos-duration="800">
                                        <span class="tc" data-count="<c:out value="${retMap.solarDvlpResult}" />"></span>그루
                                    </p>
                                    <div class="line">
                                        <svg>
                                ...
                                <li>
                                    ...
                                    <p class="count" data-aos="fade-up" data-aos-delay="500" data-aos-duration="800">
                                        <span class="tc" data-count="<c:out value="${retMap.digstngasDvlpResult}" />"></span>그루
                                    </p>
                                    <div class="line">
                                        <svg>
                                ...
                                <li>
                                    ...
                                    <p class="count" data-aos="fade-up" data-aos-delay="500" data-aos-duration="800">
                                        <span class="tc" data-count="<c:out value="${retMap.digstntakDvlpResult}" />"></span>그루
                                    </p>
                                    <div class="line">
                                        <svg>
                                            <polyline class="rect" points="227,30 196,0 0,0" fill="none" stroke="#000" stroke-width="1"></polyline>
                                ...
                                <li>
                                    ...
                                    <p class="count" data-aos="fade-up" data-aos-delay="500" data-aos-duration="800">
                                        <span class="tc" data-count="<c:out value="${retMap.steamDvlpResult}" />"></span>그루
                                    </p>
                                    <div class="line">
                                        <svg>
                                            <polyline class="rect" points="0,30 30,0 227,0" fill="none" stroke="#000" stroke-width="1"></polyline>
                                ...
                                <li>
                                    ...
                                    <p class="count" data-aos="fade-up" data-aos-delay="500" data-aos-duration="800">
                                        <span class="tc" data-count="<c:out value="${retMap.etcDvlpResult}" />"></span>그루
                                    </p>
                                    <div class="line">
                                        <svg>
                                            <polyline class="rect" points="227,30 196,0 0,0" fill="none" stroke="#000" stroke-width="1"></polyline>
