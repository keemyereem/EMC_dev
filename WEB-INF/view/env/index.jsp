            ...
            <div class="contents cont_main">
                ...
                <section class="section2">
                    <div class="tit_area">
                        ...
                        <p class="sub_con" data-aos="fade-up" data-aos-delay="500">
                            <b>끊임없는 도전</b>과 오랜 기간 <br class="br_m">축적한 경험을 바탕으로<br class="br_pc">
                            <b>환경분야 <br class="br_m">최고 수준의 기술력</b>을 갖춘 <br class="br_m">기업이 될 것입니다.
                        </p>
                    </div>  
                    <div class="line"></div>  
                    <ul class="business_list ani-on">
                        <li data-type="parallax" data-speed="20"><a href="<c:url value='/env/bsnsintrcn/bsnsintrcnList.do?MENUNO=2&SUB_MENUNO=1&searchBsnsintrcnCode=A012001&searchClCode=A012003&ctgryNo=1' />" title="페이지 이동">
                        ...
                        <li data-type="parallax_reverse" data-speed="20"><a href="<c:url value='/env/bsnsintrcn/bsnsintrcnList.do?MENUNO=2&SUB_MENUNO=2&searchBsnsintrcnCode=A012002&searchClCode=A012009&ctgryNo=' />" title="페이지 이동">
                        ...
                        <li data-type="parallax" data-speed="30"><a href="<c:url value='/sub.do?MENUID=02_02_0011&MENUNO=2' />" title="페이지 이동">
                        ...
                        <li data-type="parallax_reverse" data-speed="30"><a href="<c:url value='/sub.do?MENUID=02_02_0021&MENUNO=2' />" title="페이지 이동">
                ...
                <section class="section3">
                    <div class="tit_area">
                        ...
                        <p class="sub_con" data-aos="fade-up" data-aos-delay="500">
                            <b>지속 가능한 친환경 경영<br class="br_m"></b>을 실천하는 emc
                        </p>
                    </div> 
