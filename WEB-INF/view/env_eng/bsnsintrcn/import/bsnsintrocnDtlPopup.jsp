...
<c:if test="${retMap.langCode eq 'C001002'}"><c:set var="ctgryNm" value="${retMap.ctgryCodeEngNm}" /></c:if>
                        ...
                        <div class="txt_box">
                          ...
                          <c:when test="${bsnsintrcnCode eq 'A012001' }">
                            ...
                            <table class="card_info card_tb">
                                <thead>
                                    <tr><td colspan="4">(km) Extension of Pipeline</td></tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <dl>
                                                <dt>existing sewage pipeline</dt>
                                                <dd>
                                        ...
                                        <td>
                                            <dl>
                                                <dt>newly built rainwater pipeline</dt>
                                                <dd>
                                        ...
                                        <td>
                                            <dl>
                                                <dt>existing rainwater pipeline</dt>
                                                <dd>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <dl>
                                                <dt>Development of process control</dt>
                                                <dd>
                            ...
                            <ul class="card_info card_class">
                                <li>
			                        <dl>
			                            ...
			                            <fmt:formatNumber value='${retMap.cpcty}' />㎥/day
			                            </dd>
			                        </dl>
			                    </li>
			                    <li>
			                        <dl>
			                            <dt>Development of <br>process control</dt>
			                            <dd>
			                            <c:if test="${empty retMap.msrc}">&nbsp;</c:if>
			                            <c:out value="${retMap.msrc}" />
			                            </dd>
                            ...
                            <ul class="card_class">
                                ...
                                <li>
                                    <dl>
                                        ...
                                        <c:out value="${retMap.constPeriod}" />month
                                        </dd>
                                    </dl>
                                </li>
                               <%--  <li>
