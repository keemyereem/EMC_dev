                    ...
                    <div class="sub_contents SC_sub_con">
                        ...
                        <section class="section1" data-aos="fade-up" data-aos-offset="500">
                            <div class="sc_desc">
                                ...
                                <p>
                                    환경시설관리주식회사는 독거노인 및 소년∙소녀가장 등 취약계층의 든든한 친구가 되고자 <br class="br_pc">
                                    “깨끗함”과 “따뜻함”을 모티브로 한 ‘이불빨래’와 ‘단열캡(일명 뾱뾱이) 부착’ <br class="br_m">봉사 활동을 시작 하였습니다.<br class="br_pc">
                                    행복과 따뜻한 기운이 전국적으로 확대되기를 바라는 마음으로 매일 매일 <br class="br_m">‘해피 emc 이야기’를 써나가고 있습니다.<br class="br_pc">
                                    환경시설관리주식회사의 임직원들은 환경을 보호하는 기업의 일원으로서 국가와 사회에 기여한다는 <br class="br_pc">
                                    자부심을 다른 어떤 기업에서도 느낄 수 없는 소중한 가치로 삼으며, 다양한 사회공헌활동에 모두 적극적으로 참여하고 있습니다.
                                </p>
                            </div>
                            <div class="sc_obj">
                                <img src="/resources/service/env/images/sustain/mission.png" alt="mission_img">
                                <img src="/resources/service/env/images/sustain/mission_m.png" alt="mission_m_img">
                            ...
                            <div class="sc_obj">
                                <ul>
                                    <li>
                                        ...
                                        <p>
                                            <span>'두레' 이불빨래</span>
                                            독거노인, 소년∙소녀 가장 등 <br class="br_pc">
                                            취약계층을 위해 부피가 큰 <br class="br_pc">
                                            이불빨래를 날씨 좋은 봄 여름철 <br class="br_pc">
                                            찾아가 직접 해결해드립니다.
                                        </p>
                                    </li>
                                    <li>
                                        ...
                                        <p>
                                            <span>‘온정’ 단열에어캡</span>
                                            추운 동절기 독거노인의 주거지 <br class="br_pc">
                                            방한을 위한 ‘단열 에어캡‘ 설치를 <br class="br_pc">
                                            통해 ‘온정(溫情)’을 나눕니다.
                                        </p>
                                    </li>
                                    <li>
                                        ...
                                        <p>
                                            <span>'워터' 하천정화</span>
                                            환경시설관리주식회사가 <br class="br_pc">
                                            운영∙관리하는 하수처리장 인근 <br class="br_pc">
                                            방류 하천 및 생태공원을 깨끗한 <br class="br_pc">
                                            시민의 쉼터로 가꾸는 하천정화 <br class="br_pc">
                                            활동을 정기적으로 진행합니다.
                                        </p>
                                    </li>
                                    <li>
                                        ...
                                        <p>
                                            <span>'푸드' 급식나눔</span>
                                            지역사회 복지관을 찾아 어르신들의 <br class="br_pc">
                                            식사를 정성스럽게 대접하는 급식 <br class="br_pc">
                                            나눔 활동을 진행합니다.
                                        </p>
                                    </li>
                                    <li>
