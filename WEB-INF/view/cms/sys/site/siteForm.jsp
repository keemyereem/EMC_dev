    ...
    <table class="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <textarea name="siteIntrcn" id="siteIntrcn" rows="5" placeholder="사이트 소개를 입력하세요."><c:out value='${webResult.obj.siteIntrcn }'/></textarea>
                ...
                <td>
                    ...
                    <ul class="marginT10" id="ulManage" >
                        ...
                        <li class="marginT5" id="${item.mngrId }">
                            <c:if test="${!empty(item.deptNm) }"><c:out value='${item.deptNm }'/> / </c:if>
                            <c:out value='${item.mngrExpsrNm }'/> (<c:out value='${item.mngrId }'/>)
