                        ...
                        <table class="row">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><c:out value='${webResult.obj.mngrId }'/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="marginT10" id="ulDept">
                                              ...
                                              <li class="marginT5" id="<c:out value="${webResult.obj.deptCode}" />"><c:out value='${webResult.obj.deptNm }'/>
                                ...
                                <tr>
                                    <th>담당업무</th>
                                    <td>
                                        <textarea name="chrgJob" id="chrgJob" rows="5" placeholder="담당업무를 입력하세요."><c:out value='${webResult.obj.chrgJob }'/></textarea>
                                ...
                                <tr>
                                    <th>계정상태</th>
                                    <td>
                                        <c:out value='${webResult.obj.mngrAcntSttusNm }'/>
                                        <div class="marginL20 inBlock"><a href="javascript:popOpen('loginLockHistory');" class="btn small do">계정해제이력</a></div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>등록정보</th>
                                    <td><c:out value='${webResult.obj.frstRegisterNm }'/>(<c:out value='${webResult.obj.frstRegisterId }'/>) / <fmt:formatDate type="date" pattern="yyyy-MM-dd HH:mm:ss" value="${webResult.obj.frstRegistDt}" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>수정정보</th>
                                    <td><c:out value='${webResult.obj.lastUpdusrNm }'/>(<c:out value='${webResult.obj.lastUpdusrId }'/>) / <fmt:formatDate type="date" pattern="yyyy-MM-dd HH:mm:ss" value="${webResult.obj.lastUpdtDt}" />
                                    </td>
                                </tr>
