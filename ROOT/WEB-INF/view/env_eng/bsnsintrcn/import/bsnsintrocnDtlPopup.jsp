                          ...
                          <c:when test="${bsnsintrcnCode eq 'A012001' }">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <dl>
                                                <dt>하수신설</dt>
                                                <dd><fmt:formatNumber value='${retMap.swgeNcr}' /></dd>
                                            </dl>
                                        </td>
                                        <td>
                                            <dl>
                                                <dt>하수기존</dt>
                                                <dd><fmt:formatNumber value='${retMap.swgeLegacy}' /></dd>
                                            </dl>
                                        </td>
                                        <td>
                                            <dl>
                                                <dt>우수신설</dt>
                                                <dd><fmt:formatNumber value='${retMap.exclncNcr}' /></dd>
                                            </dl>
                                        </td>
                                        <td>
                                            <dl>
                                                <dt>기존우수</dt>
                                                <dd><fmt:formatNumber value='${retMap.legacyExclnc}' /></dd>
                                            </dl>
                                        </td>
                            ...
                            <ul class="card_info card_class">
                                <li>
			                        <dl>
			                            <dt>용량</dt>
			                            <dd><fmt:formatNumber value='${retMap.cpcty}' />㎥/일</dd>
			                        </dl>
			                    </li>
			                    <li>
			                        <dl>
                          ...
                          <!-- 환경 건설 -->
                            <ul class="card_class">
                                ...
                                <li>
                                    <dl>
                                        <dt>공사기간</dt>
                                        <dd>$<c:out value="${retMap.constPeriod}" />개월</dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
