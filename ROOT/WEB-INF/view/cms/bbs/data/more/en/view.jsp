                            ...
                            <div class="tb_view">
                                ...
                                <div class="view_box">
	                                ...
	                                <div class="view_nav">
	                                    ...
	                                    <dl class="nav_prev">
	                                        <dt><span>Prev</span></dd>
	                                        <dd><a href="javascript:onGoDtl('${prevMap.nttNo}');"><c:out value='${prevMap.sj}' /></a></dt>
	                                    </dl>
	                                    </c:if>
	                                    <c:if test="${not empty nextMap}">
	                                    <dl class="nav_next">
	                                        <dt><span>Next</span></dd>
	                                        <dd><a href="javascript:onGoDtl('${nextMap.nttNo}');"><c:out value='${nextMap.sj}' /></a></dt>
	                                    </dl>
	                                     </c:if>
	                                </div>

	                                <div class="btn_box">
	                                    <div class="btn_line"><a href="javascript:onGoListPage();">List</a></div>
	                                </div>
