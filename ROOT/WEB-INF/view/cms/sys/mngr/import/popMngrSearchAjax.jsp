              ...
              <div class="searchInWrap type2">
                  <div class="boxWrap paddingR10">
                      ...
                      <div class="box width50">
                          ...
                          <div class="inBlock width100">
                              <input type="text" id="searchMngr" name="searchMngr" value="" placeholder="이름 또는 ID">
                          </div>
                      </div>
                  </div>
                  <div class="btnWrap">
...
<script>
    ...
    function onMovePage(pageNo){
        ...
        $("#mngrIdArr").val(str);
        ajax.tableList("<c:url value="/sys/mngr/import/popMngrListAjax.do" />", "listTable", null, null, "mainPopForm");
    }
