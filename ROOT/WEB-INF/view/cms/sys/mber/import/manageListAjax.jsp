...
<script>
    ...
    $(document).ready(function () {
        util.paging(${webResult.listPage.paging.currentPageNo}, ${webResult.listPage.paging.totalRecordCount}, ${webResult.listPage.paging.pageSize}, ${webResult.listPage.paging.recordCountPerPage})
	});
