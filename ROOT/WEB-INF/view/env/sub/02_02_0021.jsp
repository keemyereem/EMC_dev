                        ...
                        <div class="inner">
                            ...
                            <div class="top">
                                <ul class="tab_list" data-aos="fade-up" data-aos-duration="600" data-aos-offset="200" data-aos-delay="600">
                                    <li class="on"><a href="/sub.do?MENUID=02_02_0021&MENUNO=2">매립</a></li>
                            ...
                            <div class="circulation_wrap" data-aos="fade-up" data-aos-offset="400">
                                <p class="s_tit">소각 및 <b>재활용등의 폐기물 처리공정에서</b> 발생한 잔재물 등을 처리하는 최종과정입니다.</p>
                                <div class="img">
                                    <div class="tag">매립</div>
                                    <img src="/resources/service/env/images/business/circulation_img01.jpg" alt="와이에스텍 이미지">
                                </div>
                                <div class="desc">
                                    <h4>와이에스텍</h4>
                                    <div>
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <ul class="desc_txt">
                                                    <li>사업장 일반폐기물 : 2,658,000㎥</li>
                                                    <li>사업장 지정폐기물 : 770,000㎥</li>
                                                    <li>최대매립고 : 91.5m</li>  
                                                </ul>
                                            </li>
                                        </ul>
