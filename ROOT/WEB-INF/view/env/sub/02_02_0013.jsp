                        ...
                        <div class="inner">
                            ...
                            <div class="top">
                                <ul class="tab_list" data-aos="fade-up" data-aos-duration="600" data-aos-offset="200" data-aos-delay="700">
                                    ...
                                    <li class="on focus"><a href="/sub.do?MENUID=02_02_0013&MENUNO=2">폐열회수</a></li>
                                    <li class=""><a href="/sub.do?MENUID=02_02_0014&MENUNO=2">폐열발전</a></li>
                                </ul>
                            </div>

                            <div class="energy_wrap" data-aos="fade-up" data-aos-offset="400">
                                <p class="s_tit">폐기물 소각으로 발생하는 열에너지는 폐열보일러에서 회수하여 <br class="br_pc">스팀(온수)을 <br class="br_m">공급하고 전기를 생산하고 있습니다.</p>
                                <div class="img">
                                    <div class="tag">폐열회수</div>
                                    <img src="/resources/service/env/images/business/energy03_img01.png" alt="energy03_img01">
                                </div>
                                <div class="desc">
                                    <h4><span>총 열생산능력</span>123.3 ton/hr</h4>
                                    <div class="waste_heat_sheet">
                                        ...
                                        <ul>
                                            <li>
                                                <span class="desc_tit">충청환경에너지주식회사</span>
                                                29 ton/hr
                                            </li>
                                            <li>
                                                <span class="desc_tit">경북환경에너지주식회사</span>
                                                25 ton/hr
                                            </li>
                                        </ul>
                                    </div>
